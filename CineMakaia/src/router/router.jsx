...
import ValidateQr from "../components/validateQr/main.jsx";
    ...
    <AppProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/SelectFilm/:selectFilm/seat/theater/payout/validate/qr" element={<ValidateQr signIn={setIsLogin} login={isLogin} />} />
